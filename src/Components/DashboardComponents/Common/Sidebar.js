...
function Sidebar() {
    ...
    return (
        <div className={(current === 'setup') ? `hidden` : `bg-gray-100 h-[100%] space-y-8 border-r-2 border-dotted border-gray-400 p-2`}>
            <div>
            ...
            <div className='space-y-4'>
                ...
                <div className={current === 'customers' || current === 'customer' ? active.main : notactive.main}>
                    <Link to='/dashboard/customers'>
                        <PeopleIcon color={current === 'customers' || current === 'customer' ? active.icon.color : notactive.icon.color} fontSize='large' />
